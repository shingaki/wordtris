...
class Play extends Component {
  ...
  placeLetters = () => {
    ...
    var myColumnHeight = this.state.numLettersPerColumn[
  ...
  downClick = () => {
    ...
    if (
      ...
      425 - 25 * this.state.numLettersPerColumn[this.state.currentColumn]
    ) {
  ...
  leftClick = () => {
    ...
    if (
      ...
      this.state.currentPieceY <
        430 - 25 * this.state.numLettersPerColumn[this.state.currentColumn - 1]
    ) {
